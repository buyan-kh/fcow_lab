...
> = {
  Steps: {
    ...
    rows: [
      { primary: "Reading program evidence" },
      { primary: "Mapping mechanism claims" },
      { primary: "Comparing translational signals", secondary: "4 evidence sets" },
      { primary: "Writing the decision record" },
    ],
  },
  Reasoning: {
    active: "Thinking",
    ...
    rows: [
      { primary: "The current signal is strong, but donor translation remains untested." },
      { primary: "The next experiment should separate target-specific rescue from context-specific viability." },
    ],
  },
  Search: {
    active: "Searching the web",
    done: "Searched the web",
    query: "target validation donor rescue assay",
    rows: [
      { primary: "Open Targets Platform", secondary: "platform.opentargets.org", href: "https://platform.opentargets.org/" },
      { primary: "PubMed", secondary: "pubmed.ncbi.nlm.nih.gov", href: "https://pubmed.ncbi.nlm.nih.gov/" },
      { primary: "Human Protein Atlas", secondary: "proteinatlas.org", href: "https://www.proteinatlas.org/" },
    ],
  },
  Coding: {
    ...
    rows: [
      { primary: "Read", secondary: "program-evidence.json", mono: true },
      { primary: "Edit", secondary: "decision-record.md", mono: true, add: 18, del: 4 },
      { primary: "Run", secondary: "rank-experiments", mono: true },
    ],
  },
};
